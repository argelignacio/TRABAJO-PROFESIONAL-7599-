...
df = GeneratorFakeGraph.generate_fake_graph_df(7, 300, 0.85, 8000)
...
logger.info("Embedding matrix shape: " + str(embedding_matrix[0].shape))
...
logger.info("Node2Vec embedding matrix shape: " + str(model_2.wv.vectors.shape))
